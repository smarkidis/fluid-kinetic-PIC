% This code simulates Landau damping using
% two species: 
% species 0: electron - KINETIC
% species 1: ion - FLUID
...
c1 = 0.0;% linear parameter
c2 = 0.0;% quadratic parameter
...
% semilogy(time,histSpectrum(2,:),'Color', [0.0 0.0 0.0]);
% hold on
% semilogy(time,0.1*exp(-0.15139*time),'--','Color', [0.5 0.5 0.5]);
% xlabel('time [1/\omega_p]')
% ylabel('|E|_{k=1}')
% grid on
% legend('PIC','Linear Theory')
% set(gca,'FontSize',18)
% set(gca, 'FontName', 'Times New Roman')
% hold off
